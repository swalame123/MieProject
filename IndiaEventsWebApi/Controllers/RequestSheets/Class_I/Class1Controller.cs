    ...
    public class Class1Controller : ControllerBase
    {
        ...
        public IActionResult AllObjModelsData(AllObjModels formDataList)
        {
            ...
            try
            {
                ...
                newRow.Cells.Add(new Cell { ColumnId = GetColumnIdByName(sheet1, "Total Honorarium Spend"), Value = TotalHonorariumAmount });
                newRow.Cells.Add(new Cell { ColumnId = GetColumnIdByName(sheet1, "Total Travel Spend"), Value = TotalTravelAmount });
                newRow.Cells.Add(new Cell { ColumnId = GetColumnIdByName(sheet1, "Total Travel & Accomodation Spend"),Value = s});
                newRow.Cells.Add(new Cell { ColumnId = GetColumnIdByName(sheet1, "Total Accomodation Spend"), Value = TotalAccomodateAmount });
                ...
                newRow.Cells.Add(new Cell { ColumnId = GetColumnIdByName(sheet1, "Total Spend"), Value = total });
